...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "SCENE VIEW (Outliner)\n"
        "- Treat get_scene_info as your Outliner. Use it to see and verify scene organization, hierarchy, selection, and active state.\n"
        "- Pattern for any scene-changing task:\n"
        "  1) snapshot_before = get_scene_info(expand_depth=1, include_counts=True) and preserve fold_state\n"
        "  2) perform the changes (create/move/assign/etc.)\n"
